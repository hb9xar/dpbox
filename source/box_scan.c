...
time_t get_headerdate(char *timestr)
{
  ...
  /* fbb515 y2k bug? - THIS BREAKS DATES STARTING FROM 2010... ! 2010-01-05 HB9XAR */
  /* if (timestr[2] == '1' && isdigit(timestr[3]) && isdigit(timestr[4])) fbby2kbug = 1; */
  /* this should work: fbb515 y2k bug gives 3digit year -> R:123mmdd/hhmmz */
  if ( (timestr[9] == '/') && (timestr[2] == '1') && isdigit(timestr[3]) && isdigit(timestr[4])) fbby2kbug = 1;
